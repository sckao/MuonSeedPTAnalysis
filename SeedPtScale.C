...
// *****************************************************************
   ...
   for ( int i=0; i<sz; i++) {
       ...
       cout<<" pt:"<< pt[i] <<" mean = "<< mean <<" rms :"<< rms <<endl;
 ...
 //TF1 *func0 = new TF1("func0", SeedFitFunc, &SeedPtFunction::fitf, 5, 1100, np, "SeedPtFunction","fitf");
 ...
 fprintf (dfile," vdouble %s_%d_scale = { %f, %f, %f, %f, %f } \n"
 ...
 //ophi_Pt = new TGraphErrors(sz, pt, ophi, ptErr, ophiErr);
 ...
 //TF1 *func2 = new TF1("func2", SeedFitFunc, &SeedPtFunction::linear, 5, 1000, 2, "SeedPtFunction","linear");
